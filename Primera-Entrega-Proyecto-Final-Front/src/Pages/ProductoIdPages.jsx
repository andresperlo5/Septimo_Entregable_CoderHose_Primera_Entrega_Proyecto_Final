...
function ProductoIdPages() {
    ...
    const GetProduct = async () => {
        const res = await axios.get(`http://localhost:3001/api/productos/${params.id}`)
        setProduct(res.data)
    ...
    const handleSubmitCarrito = async (e) => {
        ...
        const res = await axios.post(`http://localhost:3001/api/carritos/${idCart}/productos/${idProd}`)
        ...
        <div key={product.id} className="card" style={{ width: '100%' }}>
            ...
            <div className="card-body">
                ...
                <div className='d-flex justify-content-around'>
                    ...
                    <a href="#" className="btn btn-warning" id={product.id} onClick={handleSubmitCarrito}>Agregar Al Carrito</a>
                </div>
            </div>
        </div>
