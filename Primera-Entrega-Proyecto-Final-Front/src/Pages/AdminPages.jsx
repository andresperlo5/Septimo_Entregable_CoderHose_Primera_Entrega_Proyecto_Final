...
function AdminPages() {
    ...
    const handleSubmitEdit = async (e) => {
        ...
        const res = await axios.get(`http://localhost:3001/api/productos/${idProd}`)
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await axios.put(`http://localhost:3001/api/productos/${idProd}/usuario/${idAdmin}`, {
    ...
    const handleDelete = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`http://localhost:3001/api/productos/${idProd}/usuario/${idAdmin}`)
                Swal.fire(
                    'Eliminado',
        ...
        <div key={p.id} className="card" style={{ width: '100%' }}>
            ...
            <div className="card-body">
                ...
                <div className='d-flex justify-content-around'>
                    <div className='d-flex justify-content-around'>
                        <div>
                            <button type="button" class="btn btn-primary" id={p.id} data-bs-toggle="modal" data-bs-target="#exampleModal1" onClick={handleSubmitEdit}>
                                Editar
                            </button>

                        </div>
                        <div>
                            <button type="submit" className='btn btn-danger' id={p.id} onClick={handleDelete}>Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
